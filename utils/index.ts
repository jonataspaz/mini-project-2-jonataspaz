...
export async function getCars(filters: FilterProps) {
  ...
  const headers = {
    "X-RapidAPI-Key": "f06335ceb3mshcc67fc3f48d8b40p133588jsn62d513f48633",
    "X-RapidAPI-Host": "cars-by-api-ninjas.p.rapidapi.com",
  };
  const response = await fetch(
    `https://cars-by-api-ninjas.p.rapidapi.com/v1/cars?fuel_type=electricity&limit=10&year=2022&make=${manufacturer}&model=${model}`,
    {
      headers: headers,
    }
  );
